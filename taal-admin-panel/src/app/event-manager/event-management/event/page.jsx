...
//   const handleBlockStatusToggle = async (specialOfferId, newStatus) => {
//     setLoadingId(specialOfferId);
//     try {
...
//       if (error) {
//         showToast("error", "Failed to update special offer status");
//         return;
//       }

//       setEvents((prev) =>
//         prev.map((p) => (p._id === specialOfferId ? { ...p, isActive } : p))
//       );

//       showToast(
//         "success",
//         `Special offer status updated to ${isActive ? "Active" : "Inactive"}`
//       );
//       console.log(newStatus, "newStatus Received....");
//     } catch (error) {
...
//                 disabled={evnetLoading}
//               >
//                 <RefreshCw className="w-5 h-5 mr-1" /> Refresh
//               </Button>

//               <AddEvent
//                 onSuccess={(addedSpecialOffers) => {
//                   if (!addedSpecialOffers) return;
//                   setEvents((prev) => [addedSpecialOffers, ...prev]);
//                 }}
//               />
//             </div>
//           </div>
...
//             <span>Error: {eventError || "Failed to fetch offers."}</span>
//           </Alert>
//         )}
...
//                       {event?.title || "N/A"}
//                     </TableCell>
//                     <TableCell>{event?.venueName || "N/A"}</TableCell>
//                     <TableCell>{event?.address?.city || "N/A"}</TableCell>
//                     <TableCell>
//                       {event?.startDate
...
//                         <span>{event?.sessions?.length || 0}</span>
//                         <button
//                           className="px-2 py-1 text-xs bg-blue-600 text-white rounded hover:bg-blue-700"
//                           onClick={() => navigate(`/sessions/${event?._id}`)}
//                         >
//                           View Sessions
//                         </button>
//                       </div>
                  ...
                  <div className="p-4 flex flex-col gap-2 flex-1">
                    ...
                    <div className="flex justify-between items-center mt-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          className="px-2 py-1 text-xs bg-blue-600 text-white rounded hover:bg-blue-700"
                          onClick={() =>  router.push(`/event-manager/event-management/event-sessions/${event._id}`)}
                        >
                          View
                        </button>
                      </div>
