...
// Dialogs (rent product)
import AddRentProduct from "@/components/_dialogs/AddRentProduct";
import EditRentProduct from "@/components/_dialogs/EditRentProduct";
// import DeleteRentProduct from "@/components/_dialogs/DeleteRentProduct";
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      const endpoint = trimmedSearchQuery
        ? `/superadmin/search-rent-products?search=${trimmedSearchQuery}`
        : `/superadmin/get-all-rent-products?page=${currentPage}`;
              ...
              {products.map((product) => {
                ...
                return (
                  <TableRow key={product._id}>
                    ...
                    <TableCell>₹{product.rentPricePerDay}</TableCell>
                    ...
                    <TableCell className="flex gap-2">
                      <Button>
                        <Link
                          href={`/admin/product-mangement/rental-products/${product._id}`}
                        >
                          View
                        </Link>
                      </Button>
